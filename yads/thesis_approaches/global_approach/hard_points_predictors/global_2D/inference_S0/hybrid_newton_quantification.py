...
def main():
    test = pd.read_csv(
        "data/test_02_q_5_35_dt_01_10.csv",
    ...
    df.to_csv("./results/result_quantification_test_100_103.csv", sep="\t", index=False)
    return
...
if __name__ == "__main__":
    ...
    S_model = DeconvNet(5, 128)
    S_model.load_state_dict(torch.load("model/global_2D_s0.pt"))
