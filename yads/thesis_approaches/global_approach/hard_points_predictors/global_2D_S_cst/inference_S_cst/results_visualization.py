...
test = pd.read_csv("result_quantification_test_S_cst_nb_newton_sup_200.csv", sep="\t")
# test['improvement'] = test['nb_newton_classic'] - test['nb_newton_hybrid']
# print(test['improvement'].describe())

# fig = plt.figure(figsize=(10, 10))
# plt.scatter(x=test['nb_newton_classic'], y=test['nb_newton_hybrid'],
...
# plt.xlabel(r'Number of Newton iterations using''\n'r'$\bf{Classic}$ $\bf{methodology}$')
# plt.ylabel(r'Number of Newton iterations using''\n'r'$\bf{Hybrid}$ $\bf{methodology}$')
...
# plt.title("Comparison of total number of Newton iterations on the test set using \nclassic and hybrid methodologies", fontsize=18)
# fig.tight_layout()
# plt.savefig('newton_comparison.png', dpi=500)
plt.hist(test["nb_newton_hybrid"])
