...
trainX, trainY = (
    train[["log_q", "dt_init", "S0_single"]].to_numpy(),
    np.array(list(train["S"])),
)
testX, testY = (
    test[["log_q", "dt_init", "S0_single"]].to_numpy(),
...
# save the model
dump(model, open("models/giga_hard/model_knn_dist.pkl", "wb"))
# save the scaler
dump(scaler, open("models/giga_hard/scaler.pkl", "wb"))
