...
if __name__ == "__main__":
    ...
    df["S0_single"] = [elt[0] for elt in df["S0"]]
    X, y = df[["log_q", "total_time", "S0_single"]].to_numpy(), np.array(list(df["S"]))
    ...
    model = KerasRegressor(build_fn=create_256_mlp, epochs=30, batch_size=10, verbose=0)
