...
from yads.predictors.easy_points_predictors.second_approach.utils import args_to_dict
from yads.predictors.easy_points_predictors.second_approach.make_pipeline import (
    make_pipeline_lhs,
)
...
lhd = lhs(3, samples=5000, criterion="maximin")
...
make_pipeline_lhs(
    ...
    data_dict=data_dict,
    savepath="data/second_approach_5000",
)
