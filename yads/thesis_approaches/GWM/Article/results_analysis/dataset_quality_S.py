...
if __name__ == "__main__":
    ...
    print(
        compute_dataset_quality(
            physical_variable_df, "GWM_S_predict_local", "S_true_local"
        )
    )
    print(
        compute_dataset_quality(
            physical_variable_df, "Local_S_predict_local", "S_true_local"
        )
    )
