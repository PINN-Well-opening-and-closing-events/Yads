...
well_locs_cell_idxs = [i for i,_ in enumerate(grid.cells) if is_well_loc_ok(grid.centers(item="cell")[i], grid, K, 1)]
...
legend_labels = ['No sampling locations', 'Possible sampling locations', 'Permeability barriers',  'Sampled locations']
...
legend = ax.legend(loc='upper center', bbox_to_anchor=(0.5, -0.01), ncol=2, fontsize='large')
