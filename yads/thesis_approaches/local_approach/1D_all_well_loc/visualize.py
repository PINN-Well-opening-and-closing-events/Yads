...
df_1 = pd.read_csv('data/manuscrit/all_sim_5000_4_1_2500_1447.csv', sep='\t', converters={"well_loc": literal_eval})
...
df_2 = pd.read_csv('data/manuscrit/all_sim_5000_4_1_2500_1259.csv', sep='\t', converters={"well_loc": literal_eval})
